...
public class Main
{
	...
	public static final double ENGINE_VERSION = 1.114;
	public static final int ENGINE_BUILD = 14;
	...
	public static final boolean DRAW_WIREFRAME = false;			// Toggles drawing in wireframe
	...
	{		
		...
		entityHandler = new EntityHandler(8192 / 2);
		...
		mapEntityHandler = new MapEntityHandler(16);
		physicsHandler = new PhysicsHandler();
		gameEventHandler = new GameEventHandler(16);
		fpsCounter = new FramesCounter();
		gameMain = new GameMain();
		animationHandler = new AnimationHandler(16);
		...
		resourceHandler.addResource("exitunselected.png");
		resourceHandler.addResource("exitselected.png");
		resourceHandler.addResource("asianguy.png");
		resourceHandler.addResource("arrowleft.png");
		resourceHandler.addResource("arrowright.png");
		resourceHandler.addResource("arrowup.png");
		...
		if (exitCode == 1 || exitCode == 2)
		{
			...
			Material mat1 = new Material("pop material", (new File("resources\\sound\\pop.wav")));
			mat1.playSound();
